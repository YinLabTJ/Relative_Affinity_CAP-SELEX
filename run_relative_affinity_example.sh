...
# The sequence files should contain 40bp DNA sequence only, not fastq format. And the name of the sequence files should be consistent with the batch file.
...
#filter_list was created with MI pipeline (https://github.com/YinLabTJ/MI_CAP-SELEX) using the same batch_file
